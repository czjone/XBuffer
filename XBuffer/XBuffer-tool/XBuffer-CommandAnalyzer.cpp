...
CommandAnalyzer::CommandAnalyzer(): prog_name_(), argc_(0), argv_(), options_(), help_() {}


int CommandAnalyzer::get_optind(const char *name) const
{
...
int CommandAnalyzer::get_optind(char letter) const
{
	if (letter == 0) {
...
bool CommandAnalyzer::is_new_option(const char *name, char letter)
{
...
bool CommandAnalyzer::add_flag(const char *name, char letter, const char *desc)
{
...
bool CommandAnalyzer::add_flag(char letter, const char *desc)
{
	return add_flag("", letter, desc);
}


bool CommandAnalyzer::add_option_str(const char *name, char letter, const char *v0, const char *desc)
{
	assert(is_new_option(name, letter));
...
bool CommandAnalyzer::add_option_str(char letter, const char *v0, const char *desc)
{
	return add_option_str("", letter, v0, desc);
}


bool CommandAnalyzer::add_option_int(const char *name, char letter, int v0, const char *desc)
{
	assert(is_new_option(name, letter));
...
bool CommandAnalyzer::add_option_int(char letter, int v0, const char *desc)
{
	return add_option_int("", letter, v0, desc);
}


bool CommandAnalyzer::add_option_double(const char *name, char letter, double v0, const char *desc)
{
	assert(is_new_option(name, letter));
...
bool CommandAnalyzer::add_option_double(char letter, double v0, const char *desc)
{
...
bool CommandAnalyzer::parse_argv(int argc, char **argv)
{
	prog_name_ = argv[0];
...
bool CommandAnalyzer::is_true(const char *name) const
{
	int j = get_optind(name);
...
bool CommandAnalyzer::is_true(char letter) const
{
	int j = get_optind(letter);
...
const char *CommandAnalyzer::get_value_str(const char *name) const
{
	int j = get_optind(name);
...
const char *CommandAnalyzer::get_value_str(char letter) const
{
	int j = get_optind(letter);
...
int CommandAnalyzer::get_value_int(const char *name) const
{
	int j = get_optind(name);
...
int CommandAnalyzer::get_value_int(char letter) const
{
	int j = get_optind(letter);
...
double CommandAnalyzer::get_value_double(const char *name) const
{
	int j = get_optind(name);
...
double CommandAnalyzer::get_value_double(char letter) const
{
	int j = get_optind(letter);
...
int CommandAnalyzer::get_argc() const {return argc_;}


const char *CommandAnalyzer::get_arg(int i) const
{
	if (i < 0 || i >= argc_) {
...
const char *CommandAnalyzer::auto_usage()
{
	int nindent = 28;
...
void CommandAnalyzer::show_options() const
{
...
int main(int argc,char** argv) {
    // XBF::XBuffer buffer;
    // int ret = buffer.Gernerator(args);
    // return ret;
